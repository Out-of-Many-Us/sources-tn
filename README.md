...
So Tennessee's August 2026 election is one place, `2026/2026-08-06/`, holding 18 counties and
67 files, rather than scattered across 18 county folders. Nine documents carry no readable
...
| value | count | meaning |
|---|---:|---|
| `unknown` | 93 | the document says nothing about its status, or nothing readable |
...
**45 of the 124 documents are scans with no embedded text layer.** Of those, most were read by
OCR. **11 of the 124 yield no text by any means**, native or OCR, and every one of those carries
